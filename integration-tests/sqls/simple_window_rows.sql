SELECT
    ...
    SUM(c2) OVER(PARTITION BY c5, c7, c9 ORDER BY c3, c5 ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) as summation20,
    SUM(c2) OVER(PARTITION BY c5 ORDER BY c3, c5 ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) as summation21,
